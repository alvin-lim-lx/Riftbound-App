      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', flex: 1 }}>
          <div style={{ color: '#94a3b8', fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            {pendingSpell.targetType === 'gear' ? 'Gear' : 'Targets'}
          </div>
        ...
        <div style={{ display: 'flex', gap: '8px', flexShrink: 0 }}>
          ...
          <button
            ...
            style={{
              background: pendingSpell.targetType === 'gear' || pendingSpell.selectedTargetIds.length > 0
                ? '#22c55e'
                : '#1a3a2a',
              border: 'none',
              borderRadius: '6px',
              color: pendingSpell.targetType === 'gear' || pendingSpell.selectedTargetIds.length > 0
                ? '#fff'
                : '#4a6a5a',
              fontSize: '13px',
              fontWeight: 700,
              padding: '8px 14px',
              cursor: pendingSpell.targetType === 'gear' || pendingSpell.selectedTargetIds.length > 0
                ? 'pointer'
                : 'not-allowed',
            }}
          >
