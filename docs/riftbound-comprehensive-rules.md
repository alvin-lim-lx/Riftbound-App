...
Source PDF: https://cmsassets.rgpub.io/sanity/files/dsfx7636/news_live/861747d1d4d505b7c14d73aba9749d1c3a209a67.pdf

Extracted for local search/reference. Page numbers refer to the PDF page order.
...
107.3.b.2. If the maximum occupancy of a Facedown Zone decreases to a number less than the number of cards currently located there, the controller of that Facedown Zone must put a number of cards equal to the difference in the trash from the
...
Instruction , it first has its Deathknell added to the chain as a Pending Item. Note the unit's location, attributes, and other relevant information to process its Deathknell when finalized before completing this Kill Instruction .
...
The player wins immediately, without needing to wait for a cleanup to occur.
...
435. Detach
435.1. Detaching is the act of unlinking two cards that are currently linked through the act of Attaching . This causes one to cease being Attached , and potentially causes the other to cease being a Top-Most
...
Permanents will be Created to any location on the Board that they can be played to.
...
456.3. If a Combat and Showdown are staged at the same Battlefield and the turn player initiates the
...
459.2.b.4.a. If a Unit controlled by the Defender becomes present at this Battlefield

## Page 70

after this moment it will gain the Defender designation during the Cleanup phase following the action that caused it to become present
...
461.3.b. A Player has lost a combat if they received either the attacker or defender designation and

## Page 72

are the only Player that does not have any units remaining at this battlefield during this step.
